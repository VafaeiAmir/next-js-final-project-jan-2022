...
// const profileItems = getParsedCookie('addedToProfile') || [];
//   const [userProfile, setUserProfile] = useState(profileItems);

//   function clickAddToProfile(id) {
//     // is id in array => return true or false
//     const idExistInArray = userProfile.some((cookieObject) => cookieObject.id === id);

//     // find in array => return single object with same id
//     const recipeWithSameId = userProfile.find(
//       (cookieObject) => cookieObject.id === id,
//     );

//     // filter array => return an array without product with same id
//     const recipesWithDifferentId = userProfile.filter(
//       (cookieObject) => cookieObject.id !== id,
//     );
